...
namespace SwitchRemoteGUI
{
    public partial class Form1 : Form
    {
        ...
        // 上部コントロール
        RotatableButton? btnCustom;     // カスタムボタン表示切替
        RotatableButton? btnHoldToggle; // 連射切替
        RotatableButton? btnMenu;       // メニュー開閉
